...
from dataloaders.crossMoDA import (MoDA, RandomCrop,
...
parser.add_argument('--root_path', type=str,
                    default='../../../DA/data/', help='Name of Experiment')
parser.add_argument('--exp', type=str,
                    default='MoDA_Mean_Teacher', help='experiment_name')
...
def train(args, snapshot_path):
    ...
    unlabeled_idxs = list(range(args.labeled_num, total_num))
